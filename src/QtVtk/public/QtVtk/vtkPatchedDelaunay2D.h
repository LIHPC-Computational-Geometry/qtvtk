//
// Notes CP :
// Version patchée de vtkDelaunay2D qui, à l'origine, à tendance à boucler
// à l'infini (récursion infinie de CheckEdge).
// Au 13/10/14, 2 patchs sont disponibles sur internet :
// - Joachim Pouderoux, distribuée dans la version de développement de VTK,
// (=> > 6.1.0). Elle apporte un mieux mais est encore capable de boucler à
// l'infini.
// - Federico Bonelli : semble OK, il est appliqué ici aux sources de VTK
// 6.1.0
//
// Les lignes modifiées sont balisées par "CP".
//
// A noter la présence possible d'un bogue, balisé dans le source.
//

/*=========================================================================

  Program:   Visualization Toolkit
  Module:    vtkPatchedDelaunay2D.h
...
=========================================================================*/
// .NAME vtkPatchedDelaunay2D - create 2D Delaunay triangulation of input points
// .SECTION Description
// vtkPatchedDelaunay2D is a filter that constructs a 2D Delaunay triangulation from
...
#ifndef __vtkPatchedDelaunay2D_h
#define __vtkPatchedDelaunay2D_h

//#include "vtkFiltersCoreModule.h" // For export macro	// CP
...
public:
  ...
  static vtkPatchedDelaunay2D *New();
...
//  void SetSourceData(vtkPolyData *);	// CP
  void SetSource(vtkPolyData *);	// CP
...
//  double tol, vtkIdType nei[3], vtkIdList *neighbors);	// CP
	double tol, vtkIdType nei[3], vtkIdList *neighbors, vtkIdList* tried);// CP
...
private:
  vtkPatchedDelaunay2D(const vtkPatchedDelaunay2D&);  // Not implemented.
  void operator=(const vtkPatchedDelaunay2D&);  // Not implemented.
};
